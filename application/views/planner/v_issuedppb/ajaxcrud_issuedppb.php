...
<script>
    $(document).ready(function() {
        ...
        var data<?= $title ?> = $('#data<?= $title ?>').DataTable({
            ...
            "autoWidth": false,
            "responsive": true,
            "ajax": "<?= base_url("index.php/planner/" . $title . "/data" . $title . "") ?>",
            stateSave: true,
            "order": []
        })
        ...
        $('#formtambahdata<?= $title ?>').on('submit', function() {
            ...
            $.ajax({
                type: "post",
                url: "<?= base_url('index.php/planner/' . $title . '/tambah' . $title . '') ?>",
                beforeSend: function() {
                    swal({
                        title: 'Menunggu',
                        html: 'Memproses data',
        ...
        $('#data<?= $title ?>').on('click', '.create-quotation', function() {
            ...
            $.ajax({
                type: "post",
                url: "<?= base_url('index.php/planner/inquiry/formcreatequotation') ?>",
                beforeSend: function() {
                    swal({
                        title: 'Menunggu',
                        html: 'Memproses data',
