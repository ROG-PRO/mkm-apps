                ...
                <div class="col-12">
                    ...
                    <div class="card card-success card-outline">
                        <div class="card-header py-3">
                            ...
                            <a href="<?= base_url('engineering/materialrequest/create_mr') ?>" class="btn btn-success btn-sm">Without SO part reference</a>
                            <br />
                            <div class="callout callout-success" style="background: #DAF5DC;padding: 0px">
                                <div class="card-body">
                                    <form action="<?= base_url('engineering/materialrequest/addmrdetail') ?>" method="post">
                        ...
                        <div class="card card-success card-outline">
                            ...
                            <div class="card-body">
                                <form action="<?= base_url('engineering/materialrequest/addmr') ?>" method="post" class="form-horizontal">
                                    <div class="form-row">
