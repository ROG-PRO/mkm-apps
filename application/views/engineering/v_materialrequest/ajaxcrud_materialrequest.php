...
<script>
    $(document).ready(function() {
        ...
        $('#formtambahdata<?= $title ?>').on('submit', function() {
            ...
            $.ajax({
                type: "post",
                url: "<?= base_url('index.php/engineering/' . $title . '/tambah' . $title . '') ?>",
                beforeSend: function() {
                    swal({
                        title: 'Menunggu',
                        html: 'Memproses data',
        ...
        $('#data<?= $title ?>').on('click', '.create-quotation', function() {
            ...
            $.ajax({
                type: "post",
                url: "<?= base_url('index.php/engineering/inquiry/formcreatequotation') ?>",
                beforeSend: function() {
                    swal({
                        title: 'Menunggu',
                        html: 'Memproses data',
        ...
        $('#data<?= $title ?>').on('click', '.hapus-<?= $title ?>', function() {
            ...
            swal({
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?= base_url('index.php/engineering/' . $title . '/delete_mr_all') ?>",
                        method: "post",
                        /*beforeSend: function() {
                            swal({
                                title: 'Menunggu',
