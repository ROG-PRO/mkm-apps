                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body">
                            ...
                            <!-- <div class="card-body"> -->
                            <form action="<?= base_url('engineering/materialrequest/savemr_wsop/' . $so_number . '/' . $mr_no) ?>" method="post" class="form-horizontal">
                                <div class="form-row">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm">
                                        ...
                                        <tbody id="">
                                            <?php for ($i = 0; $i < count($sodetail);) : ?>
                                                <tr>
                                                    <td>
                                                        <input style="width: 100%" type="text" name="mr_item[<?= $i ?>]" value="<?= $sodetail[$i]->inq_part_no ?>">
                                                        <!-- <input style="width: 100%" type="hidden" name="so_number[<?= $i ?>]" value="<?= $sodetail[$i]->sod_sono ?>"> -->
                                                    </td>
                                                    <td><input style="width: 100%" type="text" name="mr_item_nm[<?= $i ?>]" value="<?= $sodetail[$i]->inq_part_nm ?>"></td>
                                                    <td><input style="width: 100%" type="text" name="mr_rmpartno[<?= $i ?>]" placeholder="Input model" value="<?= $sodetail[$i]->part_no ?>"></td>
                                                    <td><input style="width: 100%" type="text" name="mr_rmlong[<?= $i ?>]" placeholder="Input model" value="<?= $sodetail[$i]->rm_long ?>"></td>
                                                    <td><input style="width: 100%" type="text" name="mr_rmwidth[<?= $i ?>]" placeholder="Input model" value="<?= $sodetail[$i]->rm_width ?>"></td>
                                                    <td><input style="width: 100%" type="text" name="mr_rmheight[<?= $i ?>]" placeholder="Input model" value="<?= $sodetail[$i]->rm_height ?>"></td>
                                                    <td><input style="width: 50px" type="text" name="mr_soqty[<?= $i ?>]" value="<?= $sodetail[$i]->sod_qty ?>"></td>
                                                    <td><input style="width: 50px;background:yellow" type="text" name="mr_qty[<?= $i ?>]" value=""></td>
                                                    <td><input style="width: 50px" type="text" name="mr_unit[<?= $i ?>]" value="<?= $sodetail[$i]->inq_nm_unit ?>"></td>
                                                    <!-- <td><input type="date" name="po_deldt[<?= $i ?>]" value="<?= $sodetail[$i]->quo_deldt ?>"></td> -->
                                                    <td><input style="width: 100%" type="text" name="mr_soa[<?= $i ?>]" placeholder="SOA"></td>
                                                    <td><input style="width: 100%" type="text" name="mr_supplier[<?= $i ?>]" placeholder="Supplier"></td>
                                                    <!--  <td>
                                    ...
                                    <hr>
                                    <button type="submit" name="savepo" class="btn btn-success btn-sm" style="margin-bottom: 5px;float:right"> Update</button>
