...
<div class="container">
    <br />
                <a href="<?= base_url('engineering/materialrequest/print_mr_p1/' . $uri4 . ' ') ?>" id="hide" class="btn btn-default btn-sm">
                    <i class="fas fa-print"></i> Page 1
                </a>
                <a href="<?= base_url('engineering/materialrequest/print_mr_p2/' . $uri4 . ' ') ?>" id="hide" class="btn btn-default btn-sm">
                    <i class="fas fa-print"></i> Page 2
                </a>
