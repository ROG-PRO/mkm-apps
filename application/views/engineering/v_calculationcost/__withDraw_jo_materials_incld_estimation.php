        ...
        <div class="col-12 col-sm-12">
            ...
            <div class="card card-warning">
                <div class="card-header py-2">
                    <h6 class="m-0 font-weight-bold " style="padding:0px;padding-top:3px"><span class="badge badge-primary" style="font-size: 20px;"><i class="fas fa-exclamation-circle"></i> Detail Include Material</span> <button style="float:right;" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambah<?= $title ?>"><i class="fas fa-plus-circle"></i> Add Mtl
                        </button></h6>
                </div>
                ...
                <table width="100%" border="1">
                    <tr>
                        <td width="30%" align="center">
                            ...
                            <!-- <img width="100%" src="<?= base_url('drawing/' . $detailInq['inq_drawing'] . '') ?> "> -->
