            ...
            <div class="card card-secondary">
                ...
                <form action="<?php echo site_url('engineering/estimationcost/update_inq_detail_cost') ?>" method="post" class="form-horizontal">
                    <div class="card-body">
                        ...
                        <table border="0" width="100%" class="table table-responsive-sm ">
                            <tr>
                                <td>Material Cost </td>
                                <td style="width: 50px;;"><input type="text" value="<?= $tot_rm_amount; ?>"></td>

                            </tr>
                            <tr>
                                <td>Process Cost</td>
                                <td><input type="text" value="<?= $tot_process_amount; ?>"></td>

                            </tr>
                            <tr>
                                <td>Tools Cost</td>
                                <td><input type="text" value="<?= $tot_tools_amount; ?>"></td>
