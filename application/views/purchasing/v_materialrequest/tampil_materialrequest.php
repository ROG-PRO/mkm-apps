...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Log MR
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/dashboard') ?>"><i class="fa fa-home" aria-hidden="true"></i> Home</a></li>
                            <li class="breadcrumb-item active"><a href="<?php echo site_url('purchasing/materialrequest') ?>">Log <?= $uri2 ?> </a></li>
                    ...
                    <div class="col-12">
                        <div class="card card-success card-outline">
                            <div class="card-header">
                                ...
                                <h3 class="card-title"><i class="fas fa-list-alt"></i> Material Request List</h3> <a href="<?= base_url('planner/materialrequest/create_mr')?>" style="float:right;" class="btn btn-primary  btn-sm" data-toggle="" ><i class="fa fa-plus-circle" aria-hidden="true"></i> Create New MR</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped table-bordered table-sm" align="" id="data<?= $title ?>">
                                    <thead class="thead-grey" align="left">
                                        <tr>
                                            ...
                                            <th width="10%">MR code</th>
                                            <th width="8%">SO Number</th>
                                            <th>Create by</th>
                                            <th>Create dt</th>
                                            <th>Description</th>
                                            <!-- <th>Price</th>
