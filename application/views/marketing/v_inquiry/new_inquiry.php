...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-dark"><a href="<?php echo site_url('marketing/inquiry') ?>"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back </a></h5>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card card-success card-outline">
                        <div class="card-header py-3">
                            ...
                            <div class="callout callout-success" style="background: #DAF5DC;padding: 0px">
                                <div class="card-body">
                                    <form action="<?= base_url('marketing/inquiry/addinquirydetail') ?>" method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" class="form-control " name="part_no" id="part_no" value="" placeholder="Part no" required>
                                            </div>
                                            <div class="form-group col-md-3">
                                                <label for="id_inquiry">Part name</label>
                                                <input type="text" class="form-control " name="part_nm" id="part_nm" placeholder="Part name" required>
                                            </div>
                                            <div class="form-group col-md-1">
                                                <label for="Quantity">Quantity</label>
                                                <input type="text" class="form-control" name="qty" id="qty" required placeholder="Quantity">
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label for="Quantity">Unit</label>
                                                <select name="nm_unit" id="nm_unit" class="form-control " required>
                                            ...
                                            <div class="form-group col-md-1">
                                                <label for="incld_mtl">Include Mat</label>
                                                <select name="incld_mtl" id="incld_mtl" class="form-control ">
                                            ...
                                            <div class="form-group col-md-2">
                                                <label for="Quantity">Drawing</label>
                                                <input type="text" class="form-control " name="drawing" id="drawing" required placeholder="*.jpg / .pdf">
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" style="text-align:right;" class="col-sm-4 col-form-label">Customer Code</label>
                                                        <div class="col-sm-4">

                                                            <select name="cust_cd" id="customer_cd" class="form-control select2" style="width: 100%;" required="required" onchange='changeValue(this.value)'>
                                                                <option selected="selected" required="required">Please select</option>
                                                                <?php
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input required="required" type="text" class="form-control control-sm" id="customer_cd2" name="cust_cd2" placeholder="Customer cd" value="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class=" form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" id="inputPassword3" name="project_nm" placeholder="Project Name">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= $row['inquiry_detail_cby']; ?></td>
                                                                    <td><?= $row['inquiry_detail_cdt']; ?></td>
                                                                    <td><?php
                                                                    ...
                                                                    <td width="4%" align="center">
                                                                        ...
                                                                        <a href="<?php echo site_url('marketing/inquiry/hapusinquirydetail/' . $row['id_inquiry_detail']) ?>"> <i class="fas fa-trash"></i></a>
