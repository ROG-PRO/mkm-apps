                ...
                <div class="col-12">
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            ...
                            <h3 class="card-title"><i class="fas fa-list-alt"></i> Inquiry List</h3>
                            <a href="<?= base_url('marketing/inquiry/createinquiry') ?>" style="float:right;" class="btn btn-success  btn-sm" data-toggle=""><i class="fa fa-plus-circle" aria-hidden="true"></i> Create New Inquiry</a>
