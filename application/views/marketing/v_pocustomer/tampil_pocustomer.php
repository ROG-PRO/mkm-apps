...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Log Book PO </li>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    ...
                    <div class="card card-success card-outline">
                        <div class="card-header py-2">
                            ...
                            <h6 class="m-0 font-weight-bold " style="padding:0px"><i class="fas fa-list"></i> PO List</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-default">
                                        <div class="card-header py-2">
                                            <button type="button" class="btn btn-default btn-sm" data-toggle="collapse" data-target="#collapsewithInquiry"><i class="far fa-edit"></i> Input PO with Quotation reference</button>
                                            ...
                                            <form action="<?= base_url('marketing/pocustomer/input') ?>" method="post" class="form-horizontal">
                                                <div class="card-body">
                                                    <!-- <div class="form-group row">
                                                            <label for="poInquiry" class="col-sm-2 col-form-label" style="text-align:right;">Pilih Inquiry</label>
                                                            <div class="col-sm-3">
                                                                <select name="poInquiry" id="poCustomer" class="form-control">
                                                                    <option value="">-- Pilih No Inquiry --</option>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" style="text-align:right;" class="col-sm-2 col-form-label">Quotation Number</label>
                                                        <div class="col-sm-3">

                                                            <select name="poInquiry" id="id_inquiry" class="form-control select2" required style="width: 100%;" onchange='changeValue(this.value)'>
                                                                <option selected="selected">Please select</option>
                                                                <?php

                                                                $a          = "var id_inquiry = new Array();\n;";
                                                                $b          = "var type_prod = new Array();\n;";
                                                                $c          = "var type_process = new Array();\n;";

                                                                foreach ($datainquiry as $row) {
                                                                    echo '<option name="id_inquiry" value="' . $row->id_inquiry . '">' . $row->quotation_no . '</option>';
                                                                    $a .= "id_inquiry['" . $row->id_inquiry . "'] = {id_inquiry:'" . addslashes($row->id_inquiry) . "'};\n";
                                                                    $b .= "type_prod['" . $row->id_inquiry . "'] = {type_prod:'" . addslashes($row->type_prod) . "'};\n";
                                                    ...
                                                    <!-- <div class="form-group row">
                                                            <label for="poProcess" class="col-sm-2 col-form-label" style="text-align:right;">Jenis Proses</label>
                                                            <div class="col-sm-3">
                                                                <input  disabled type="text" class="form-control control-sm" id="type_process" name="poProcess" placeholder="Type Process" value="">
                                                                <!-- <select name="poProcess" id="poProcess" class="form-control" required>
                                                            ...
                                                            <!-- <div class="col-sm-4">
                                                                <input  disabled type="text" class="form-control control-sm" id="type_prod" name="cust_cd2" placeholder="Customer cd" value="">
                                                            </div> --

                                                            <label for="poProduction" class="col-sm-2 col-form-label" style="text-align:right;">Jenis Produksi</label>
                                                            <div class="col-sm-3">
                                                                <input  disabled type="text" class="form-control control-sm" id="type_prod" name="poProduction" placeholder="Type Produksi" value="">
                                                                <!-- <select name="poProduction" id="poProduction" class="form-control" required>
                                                                    <option value="">-- Pilih proses --</option>
                                                            ...
                                                            <!-- <div class="col-sm-4">
                                                                <input  disabled type="text" class="form-control control-sm" id="type_process" name="poProcess" placeholder="Customer cd" value="">
                                                            </div> --
                                                        </div> -->
                                                    <div class="form-group row">
                                                        <label for="poPono" class="col-sm-2 col-form-label" style="text-align:right;">Nomor PO Cust.</label>
                                                        <div class="col-sm-3">
                                                            <input type="text" name="poPono" class="form-control" id="poPono" placeholder="Nomor PO" required>
                                                        </div>
                                    ...
                                    <div class="card card-default">
                                        <div class="card-header py-2">
                                            <button type="button" class="btn btn-default btn-sm" data-toggle="collapse" data-target="#collapsewithoutInquiry"><i class="far fa-edit"></i> Input PO without Quotation reference </button>
                                            <!-- <h6 class="m-0 font-weight-bold " style="padding:0px"><i class="far fa-edit"></i> Input Data PO</h6> -->
                                        </div>
                                        <div id="collapsewithoutInquiry" class="panel-collapse collapse">
                                            <form action="<?= base_url('marketing/pocustomer/addpodetail') ?>" method="post" class="form-horizontal">
                                                <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered table-sm" align="" id="data<?= $title ?>">
                        ...
                        <tbody>
                            <?php
                            $n = 1;
                            foreach ($pocustomer as $row) : ?>
                                <tr>
                                    <td><?= $n++; ?></td>
                                    <td>
                                        <?php if ($row->po_soflex == 0) { ?>

                                            <a href="<?= site_url('marketing/pocustomer/d/' . strtolower($row->po_no)) ?>" class="btn btn-warning btn-xs " data-id="<?= $row->po_no ?>">Create SO</a>
                                        <?php  } else { ?>
                                            <a href="<?= site_url('marketing/pocustomer/d/' . strtolower($row->po_no)) ?>" class="btn btn-info btn-xs " data-id="<?= $row->po_no ?>">PO Details</a>
                                    ...
                                    <td><?= $row->po_pono; ?></td>
                                    <td><?= $row->po_project; ?></td>
                                    <td><?= $row->po_deliverydate; ?></td>
                                    <td>
                                        <?php if ($row->po_soflex == 0) {
                                            echo "PO";
                                        } else {
...
<script type="text/javascript">
    ...
    function changeValue(id) {
        ...
        document.getElementById('nm_unit').value = nm_unit[id].nm_unit;
        document.getElementById('product_price').value = product_price[id].product_price;
    };
</script>
