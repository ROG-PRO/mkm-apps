            ...
            <div class="modal-body">
                ...
                <form id="formtambahdata<?= $title ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input name="nm_kategori" id="nm_kategori" type="text" class="form-control">
                    </div>
                    <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        var data<?= $title ?> = $('#data<?= $title ?>').DataTable({
            ...
            "autoWidth": false,
            "responsive": true,
            "ajax": "<?= base_url("index.php/marketing/" . $title . "/data" . $title . "") ?>",
            stateSave: true,
            "order": []
        })
        ...
        $('#formtambahdata<?= $title ?>').on('submit', function() {
            var nm_kategori = $('#nm_kategori').val(); // diambil dari id part_no yang ada diform modal
            var deskripsi = $('#deskripsi').val(); // diambil dari id part_no yang ada diform modal
            ...
            $.ajax({
                type: "post",
                url: "<?= base_url('index.php/admin/' . $title . '/tambah' . $title . '') ?>",
                beforeSend: function() {
                    swal({
                        title: 'Menunggu',
                        html: 'Memproses data',
