                        ...
                        <div class="card-body">
                            ...
                            foreach ($detailinquiry as $row) {
                                ...
                                <?php } else if ($row->inquiry_status == 1) { ?>
                                    <a class="btn btn-danger btn-sm" href="<?= base_url('marketing/quotation') ?>" style="text-decoration:none;color:white;"><i class="far fa-arrow-alt-circle-left"></i> Back</a>
                                    <button style="background: grey;color: white;padding:5px;" class='btn btn-primary btn-sm create-quotation' data-toggle='modal' data-target="#modal-quo " disabled><i class='fas fa-edit'></i> Create</button>
                                ...
                                <?php } else { ?>
                                    <a class="btn btn-danger btn-sm" href="<?= base_url('marketing/quotation') ?>" style="text-decoration:none;color:white;"><i class="far fa-arrow-alt-circle-left"></i> Back</a>
                                    <button style="background: grey;color: white;padding:5px;" class='btn btn-secondary btn-sm create-quotation' data-toggle='modal' data-target="#modal-quo " disabled><i class='fas fa-edit'></i> Create
                                    </button>
                            ...
                            <div class="callout callout-success" style="background-color:#D7FCE9 ;">
                                ...
                                <table class="table table-sm" style="margin:1px; font-size:12px; " width="100%" border="0">
                                    ...
                                    ?>
                                            ...
                                            <form action="<?= base_url('marketing/quotation/createquotation/' . $uri4 . '') ?>" method="POST">
                                                <tr>
                                                    <td colspan="9">
                                                ...
                                                <tr>
                                                    <td>Subject</td>
                                                    <td>:</td>
                                                    <td><input type="text" name="subject" value="<?= $dataquoedit['subject']; ?>" class="form-control form-control-sm"></td>
                                                    ...
                                                    <td>Remark</td>
                                                    <td>:</td>
                                                    <td rowspan="2"><textarea class="form-control form-control-sm"><?= $dataquoedit['q_note']; ?></textarea></td>
                                                </tr>
                                                <tr>
                                                    <td>Customer reff</td>
                                                    <td>:</td>
                                                ...
                                                <tr>
                                                    <td>Attention</td>
                                                    <td>:</td>
                                                    <td><input type="text" name="attention" value="<?= $dataquoedit['attention']; ?>" class="form-control form-control-sm"></td>
                                                    <td>Payment Term</td>
                                                    <td>:</td>
                                                    <td><input type="text" name="payment_term" value="<?= $dataquoedit['payment_term']; ?>" class="form-control form-control-sm">
                                                        ...
                                                        <input name="id_inquiry" id="id_inquiry" type="hidden" value="<?= $uri4 ?>" class="form-control form-control-sm">
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><button style="float: right" type="submit">Create Quotation</button></td>
