            ...
            <div class="modal-body">
                ...
                <form id="formtambahdata<?= $title ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input name="process_nm" id="process_nm" type="text" class="form-control">
                    </div>
                    <!--<div class="form-group">
                        <label>Cost</label>
                        <input name="cost_process" id="cost_process" type="text" class="form-control">
                    </div>-->
...
<script>
    $(document).ready(function() {
        ...
        // pilih selector dari yang id formtambah__
        $('#formtambahdata<?= $title ?>').on('submit', function() {
            var process_nm = $('#process_nm').val();
            //var cost_process = $('#cost_process').val();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#formubahdata<?= $title ?>').on('submit', function() {
                        ...
                        var e_process_nm = $('#e_process_nm').val(); // diambil dari id part_nm yanag ada di form modal 
                        //var e_cost_process = $('#e_cost_process').val(); // diambil dari id part_nm yanag ada di form modal 
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                e_process_nm: e_process_nm,
                                //e_cost_process: e_cost_process,
                                update_by: update_by,
                                update_dt: update_dt,
                                id: id
                            }, // ambil datanya dari form yang ada di variabel
