            ...
            <div class="modal-body">
                ...
                <form id="formtambahdata<?= $title ?>">
                    ...
                    <div class="form-group">
                        <label>Lokasi Code</label>
                        <input name="cd_lok" id="cd_lok" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Nama Lokasi</label>
                        <input name="nm_lok" id="nm_lok" type="text" class="form-control">
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#formtambahdata<?= $title ?>').on('submit', function() {
            var cd_lok = $('#cd_lok').val(); // diambil dari id part_no yang ada diform modal
            var nm_lok = $('#nm_lok').val(); // diambil dari id part_no yang ada diform modal
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#formubahdata<?= $title ?>').on('submit', function() {
                        ...
                        var e_cd_lok = $('#e_cd_lok').val(); // diambil dari id part_nm yanag ada di form modal 
                        var e_nm_lok = $('#e_nm_lok').val(); // diambil dari id part_nm yanag ada di form modal 
