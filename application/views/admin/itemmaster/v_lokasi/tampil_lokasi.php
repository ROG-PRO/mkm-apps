                                    ...
                                    <thead class="thead-grey" align="left">
                                        <tr>
                                            ...
                                            <th width="8%" align="center">Action
                                                <!-- <button style="float:right;" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#tambah<?= $title ?>"><i class="fa fa-plus" aria-hidden="true"></i> New</button> -->
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody align="left">
