            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#formubahdata<?= $title ?>').on('submit', function() {
                        ...
                        var e_title = $('#e_title').val(); // diambil dari id part_nm yanag ada di form modal 
                        var e_url = $('#e_url').val(); // diambil dari id part_nm yanag ada di form modal 
                        var e_controller = $('#e_controller').val(); // diambil dari id part_nm yanag ada di form modal 
                        var e_icon = $('#e_icon').val(); // diambil dari id part_nm yanag ada di form modal 
                        var e_is_active = $('#e_is_active').val(); // diambil dari id part_nm yanag ada di form modal 
                        ...
                        $.ajax({
                            type: "post",
                            url: "<?= base_url('index.php/admin/usermanagement/user_sub_menu/ubahuser_sub_menu') ?>",
                            // beforeSend: function() {
                            //     swal({
                            //         title: 'Menunggu',
                            //         html: 'Memproses data',
