    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Access Menu</h4>
            ...
            <div class="modal-body">
                ...
                <form id="formtambahdata<?= $title ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input name="seq_no" id="seq_no" type="test" class="form-control" required>
                    </div>
                    <!-- <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $('#formtambahdata<?= $title ?>').on('submit', function() {
            ...
            var role_id = $('#role_id').val(); // diambil dari id part_nm yanag ada di form modal 
            var menu_id = $('#menu_id').val(); // diambil dari id part_nm yanag ada di form modal 
            var seq_no = $('#seq_no').val(); // diambil dari id part_nm yanag ada di form modal 
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#formubahdata<?= $title ?>').on('submit', function() {
                        var e_role_id = $('#e_role_id').val(); // diambil dari id part_nm yanag ada di form modal 
                        var e_menu_id = $('#e_menu_id').val(); // diambil dari id alamat yanag ada di form modal 
                        var e_seq_no = $('#e_seq_no').val(); // diambil dari id alamat yanag ada di form modal 
                        var id = $('#uam_id').val();
                        $.ajax({
                            type: "post",
